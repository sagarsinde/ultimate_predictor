    ...
    for m_cand in top_3_morning:
        ...
        for model_id, m_data in trained_models.items():
            ...
            _, e_probs = _predict_single(
                None, model_e_obj, model_type, X_injected, last_m, last_e, current_dow
            )
