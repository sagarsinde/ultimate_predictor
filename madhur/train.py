"""
Train all standardized fast models on the FULL historical data for Madhur.
...
# Add the madhur directory to sys.path so we can import src
...
def train_full_data():
    print(f"\n--- Training Full Data Models for MADHUR ---")
