...
def main():
    print("Fetching raw HTML for KALYAN Main from dpbosss.mobi...")
    url = 'https://sattamatkadpboss.mobi/record/kalyan-penal-chart.php'
    ...
    days_of_week = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'] # 6-day week
    ...
    for row in rows:
        ...
        date_str = cols[0]
        # Format is usually '31/12/12to5/01/13'
        try:
            start_date_str = date_str.split('to')[0].strip()
            # The year might be '12' or '2012'. We handle 2-digit years carefully.
    ...
    output_file = 'true_kalyan_main_dataset.csv'
