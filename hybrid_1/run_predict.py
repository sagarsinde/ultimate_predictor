...
Usage: python -m hybrid_1.run_predict kalyan
       python -m hybrid_1.run_predict mb
...
from hybrid_1.validator import load_state


def main():
    if len(sys.argv) < 2:
        print("Usage: python -m hybrid_1.run_predict [kalyan|mb]")
        sys.exit(1)
    ...
    if state is None:
        ...
        print(f"Run 'python -m hybrid_1.run_backtest {market}' first to build the ensemble.")
        sys.exit(1)
