...
Usage: python -m v3.run_backtest kalyan
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python -m v3.run_backtest [kalyan|mb]")
        sys.exit(1)
    ...
    print(f"  Now run: python -m v3.run_predict {market}")
    print(f"{'#'*70}\n")
