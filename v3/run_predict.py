...
Usage: python -m v3.run_predict kalyan
...
from v3.predict import predict_tomorrow
from v3.validator import load_state


def main():
    if len(sys.argv) < 2:
        print("Usage: python -m v3.run_predict [kalyan|mb]")
        sys.exit(1)
    ...
    if state is None:
        ...
        print(f"Run 'python -m v3.run_backtest {market}' first to build the ensemble.")
        sys.exit(1)
