...
Usage: python -m hybrid_1.run_backtest kalyan
       python -m hybrid_1.run_backtest mb
...
from hybrid_1.validator import (
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python -m hybrid_1.run_backtest [kalyan|mb]")
        sys.exit(1)
    ...
    print(f"  Now run: python -m hybrid_1.run_predict {market}")
    print(f"{'#'*70}\n")
